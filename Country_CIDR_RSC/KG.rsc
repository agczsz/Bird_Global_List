...
:do { add list=KG address=45.11.212.0/24 } on-error={}
...
:do { add list=KG address=168.113.216.0/21 } on-error={}
:do { add list=KG address=168.113.228.0/23 } on-error={}
:do { add list=KG address=168.113.230.0/24 } on-error={}
:do { add list=KG address=172.33.149.1/32 } on-error={}
...
:do { add list=KG address=176.101.60.192/30 } on-error={}
:do { add list=KG address=176.101.60.198/31 } on-error={}
:do { add list=KG address=176.101.60.200/29 } on-error={}
...
:do { add list=KG address=188.254.54.0/29 } on-error={}
...
:do { add list=KG address=194.1.132.0/22 } on-error={}
