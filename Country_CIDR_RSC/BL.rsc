...
:do { add list=BL address=5.187.111.176/29 } on-error={}
...
:do { add list=BL address=5.187.121.4/30 } on-error={}
:do { add list=BL address=5.187.121.246/31 } on-error={}
:do { add list=BL address=5.187.121.248/31 } on-error={}
:do { add list=BL address=5.187.121.250/32 } on-error={}
:do { add list=BL address=5.187.124.86/32 } on-error={}
...
:do { add list=BL address=23.174.120.197/32 } on-error={}
...
:do { add list=BL address=64.117.46.0/24 } on-error={}
...
:do { add list=BL address=206.130.228.0/25 } on-error={}
