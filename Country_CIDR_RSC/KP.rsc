...
:do { add list=KP address=5.62.56.160/31 } on-error={}
:do { add list=KP address=5.62.56.162/32 } on-error={}
...
:do { add list=KP address=143.246.176.122/32 } on-error={}
...
:do { add list=KP address=219.148.213.234/31 } on-error={}
