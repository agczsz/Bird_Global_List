...
:do { add list=SH address=80.73.219.141/32 } on-error={}
:do { add list=SH address=80.73.219.143/32 } on-error={}
:do { add list=SH address=80.73.220.0/23 } on-error={}
:do { add list=SH address=80.73.222.0/26 } on-error={}
:do { add list=SH address=80.73.222.128/26 } on-error={}
...
:do { add list=SH address=91.232.235.128/25 } on-error={}
