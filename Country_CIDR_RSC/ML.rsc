...
:do { add list=ML address=193.251.128.112/30 } on-error={}
:do { add list=ML address=193.251.128.125/32 } on-error={}
:do { add list=ML address=193.251.129.72/30 } on-error={}
:do { add list=ML address=193.251.131.52/30 } on-error={}
:do { add list=ML address=193.251.131.112/30 } on-error={}
:do { add list=ML address=193.251.132.60/30 } on-error={}
:do { add list=ML address=193.251.151.148/30 } on-error={}
:do { add list=ML address=193.251.170.128/25 } on-error={}
:do { add list=ML address=193.251.241.168/30 } on-error={}
:do { add list=ML address=193.251.243.100/30 } on-error={}
:do { add list=ML address=193.251.243.144/30 } on-error={}
:do { add list=ML address=193.251.243.192/30 } on-error={}
:do { add list=ML address=193.251.245.144/30 } on-error={}
