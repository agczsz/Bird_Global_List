...
:do { add list=CK address=202.4.32.0/29 } on-error={}
:do { add list=CK address=202.4.32.32/27 } on-error={}
:do { add list=CK address=202.4.32.64/26 } on-error={}
:do { add list=CK address=202.4.32.128/25 } on-error={}
