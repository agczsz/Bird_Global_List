...
:do { add list=CV address=38.71.124.0/22 } on-error={}
...
:do { add list=CV address=186.247.62.0/26 } on-error={}
:do { add list=CV address=186.247.62.64/27 } on-error={}
:do { add list=CV address=186.247.62.96/28 } on-error={}
:do { add list=CV address=186.247.62.112/29 } on-error={}
:do { add list=CV address=186.247.62.120/30 } on-error={}
:do { add list=CV address=186.247.62.124/31 } on-error={}
:do { add list=CV address=186.247.62.127/32 } on-error={}
:do { add list=CV address=186.247.62.128/25 } on-error={}
