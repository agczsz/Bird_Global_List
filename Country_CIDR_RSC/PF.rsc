...
:do { add list=PF address=65.181.28.0/23 } on-error={}
...
:do { add list=PF address=103.254.224.0/26 } on-error={}
:do { add list=PF address=103.254.224.64/30 } on-error={}
:do { add list=PF address=103.254.224.68/31 } on-error={}
...
:do { add list=PF address=103.254.224.128/25 } on-error={}
...
:do { add list=PF address=143.246.176.176/32 } on-error={}
...
:do { add list=PF address=172.225.175.208/28 } on-error={}
:do { add list=PF address=172.225.175.224/27 } on-error={}
...
:do { add list=PF address=193.50.198.5/32 } on-error={}
