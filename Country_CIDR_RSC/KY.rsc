...
:do { add list=KY address=158.69.65.60/32 } on-error={}
:do { add list=KY address=158.69.66.5/32 } on-error={}
:do { add list=KY address=158.69.66.97/32 } on-error={}
:do { add list=KY address=158.69.67.19/32 } on-error={}
:do { add list=KY address=158.69.67.231/32 } on-error={}
:do { add list=KY address=158.69.69.142/32 } on-error={}
:do { add list=KY address=158.69.70.54/32 } on-error={}
:do { add list=KY address=158.69.72.61/32 } on-error={}
:do { add list=KY address=158.69.72.98/32 } on-error={}
:do { add list=KY address=158.69.72.241/32 } on-error={}
:do { add list=KY address=158.69.73.245/32 } on-error={}
:do { add list=KY address=158.69.75.222/32 } on-error={}
:do { add list=KY address=158.69.77.210/32 } on-error={}
